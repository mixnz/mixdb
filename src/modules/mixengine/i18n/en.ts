  ...
  mixengine: {
    ...
    settings: {
      general: {
        ...
        frontEnd: "Default web server: not available in this build yet",
        frontEndComingSoon: "MixEngine has not shipped a release with this switch yet.",
      },
      autostart: {
