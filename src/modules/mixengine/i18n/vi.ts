  ...
  mixengine: {
    ...
    settings: {
      general: {
        ...
        frontEnd: "Web server mặc định: bản này chưa hỗ trợ",
        frontEndComingSoon: "MixEngine chưa phát hành bản nào có công tắc này.",
      },
      autostart: {
      ...
      uninstall: {
        ...
        start: "Gỡ MixEngine",
        confirmAgain: "Bấm lần nữa để xác nhận",
        running: "Đang gỡ… {{message}}",
